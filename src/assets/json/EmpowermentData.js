const EmpowermentData = [
    {
      ...
      description: "Gain access to training programs that will enhance your skills and knowledge, equipping you with the tools necessary to excel in the gig economy. These initiatives are designed to empower you with the expertise required for success in your chosen field.",
  ...
  export default EmpowermentData;
